/*Напишите программу, в которой определите следующий массив из пяти чисел - {1, 2, 3, 4, 5}. Инвертируй
те массив (чтобы в массиве элементы расположились в обраном порядке - {5, 4, 3, 2, 1}).*/
#include <stdio.h>
