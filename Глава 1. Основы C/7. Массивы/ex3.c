/*Напишите программу, в которой определите массив из четырех чисел - {1, 2, 3, 4}. Увеличьте все элементы массива в два раза.
Выведите все элементы массива на консоль.*/
#include <stdio.h>
