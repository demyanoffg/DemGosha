...
используя размер типа, и для одного объекта long, используя размер указателя. Поместите значения в выделенные участки памяти и выведите эти значения на консоль. 
После этого освободите выделенную память.*/
#include <stdio.h>
#include <stdlib.h>
